      ...
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="relative w-9 h-9 rounded-md text-gray-500 hover:bg-emerald-50 hover:text-emerald-700 transition-colors"
          >
            <svg
              className="mx-auto"
              width="18"
            ...
            >
              <path
                d="M15 9a5.5 5.5 0 0 1-5.5 5.5H5L2.5 16v-4.2A5.5 5.5 0 1 1 15 9Z"
                stroke="currentColor"
                strokeWidth="1.5"
          ...
          >
            ...
            >
              <path
                d="M5 7.5a4 4 0 1 1 8 0c0 4.7 2 5.2 2 5.2H3s2-.5 2-5.2ZM7.2 15h3.6"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button
            onClick={() =>
              navigate(role === "org" ? "org-profile" : "talent-profile")
            }
            aria-label="Abrir perfil"
            className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700 text-xs font-semibold hover:ring-2 hover:ring-emerald-200 transition-shadow"
          >
            {role === "org" ? "EJ" : "MC"}
          </button>
        </div>
